...
export const TRACK_JUNCTIONS_CONFIG: Record<TrackId, JunctionZoneConfig[]> = {
  ...
  cosmic_ring: [
    ...
    {
      id: 'ring_junction_corona',
      name: 'Corona Chasm Fork',
      trackId: 'cosmic_ring',
      approachT: 0.65,
      junctionStartT: 0.70,
      junctionEndT: 0.84,
      bannerText: 'CORONA CHASM DIVERGENCE',
      defaultRouteId: 'ring_corona_center',
      routes: [
        {
          id: 'ring_corona_left',
          name: 'HEAT SHIELD SKYWAY',
          direction: 'LEFT',
          subtitle: 'Protected Orbital Overpass',
          detail: 'Shielded titanium gantry protected from solar radiation surges.',
          themeColor: '#00f0ff',
          isShortcut: false,
          riskLevel: 'LOW',
          hasBoostPads: true,
          ...
          lateralDivergence: -26,
          elevationOffset: 16,
          requiredCheckpointIndices: [9, 10],
        },
        {
          id: 'ring_corona_center',
          name: 'PULSAR RUNWAY ARTERY',
          direction: 'CENTER',
          subtitle: 'Central Magnetic Highway',
          detail: 'Direct central magnetic highway with double boost acceleration pads.',
          themeColor: '#38bdf8',
          isShortcut: false,
          riskLevel: 'LOW',
          hasBoostPads: true,
        ...
        {
          id: 'ring_corona_right',
          name: 'FLARE CONDUIT SHORTCUT',
          direction: 'SHORTCUT',
          subtitle: 'Dangerous Flare Crevice (-16% Distance)',
          detail: 'Cuts straight through the solar flare exhaust chute. High risk, extreme acceleration.',
          themeColor: '#ff5500',
          isShortcut: true,
          riskLevel: 'HIGH',
          hasBoostPads: true,
  ...
  quantum_highway: [
    ...
    {
      id: 'quantum_junction_hyperspace',
      name: 'Hyperspace Conduit Fork',
      trackId: 'quantum_highway',
      approachT: 0.66,
      junctionStartT: 0.72,
      junctionEndT: 0.88,
      bannerText: 'HYPERSPACE CONDUIT FORK',
      defaultRouteId: 'quantum_hyperspace_center',
      routes: [
        {
          id: 'quantum_hyperspace_left',
          name: 'LIGHTSPEED ARTERY',
          direction: 'LEFT',
          subtitle: 'Multi-lane Supersonic Skyway',
          detail: 'Smooth acceleration tube with wide turning clearances and zero obstacle interference.',
          themeColor: '#00ffcc',
          isShortcut: false,
          riskLevel: 'LOW',
          hasBoostPads: true,
          ...
          lateralDivergence: -28,
          elevationOffset: 12,
          requiredCheckpointIndices: [10, 11],
        },
        {
          id: 'quantum_hyperspace_center',
          name: 'HYPER-TUNNEL SPINE',
          direction: 'CENTER',
          subtitle: 'Direct Tunnel Axis',
          detail: 'Direct supersonic tube with balanced acceleration strips.',
          themeColor: '#38bdf8',
          isShortcut: false,
          riskLevel: 'LOW',
          hasBoostPads: true,
        ...
        {
          id: 'quantum_hyperspace_right',
          name: 'WARP FISSURE SHORTCUT',
          direction: 'SHORTCUT',
          subtitle: 'Dimensional Crack (-15% Distance)',
          detail: 'Tight fracture in hyperspace fabric. Demands high precision steering.',
          themeColor: '#ff0055',
          isShortcut: true,
          riskLevel: 'HIGH',
          hasBoostPads: true,
